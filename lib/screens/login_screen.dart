  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        child: SafeArea(
          // PERBAIKAN 1: Menggunakan LayoutBuilder & ConstrainedBox agar tidak overflow vertikal
          // dan tetap bisa di-scroll saat keyboard muncul.
          child: LayoutBuilder(
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            // PERBAIKAN 2: Mengganti Row dengan Wrap agar tidak overflow ke kanan
                            Wrap(
